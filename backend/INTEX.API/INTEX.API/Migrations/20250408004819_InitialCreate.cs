        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComediesDramasInternationalMovies = table.Column<int>(name: "Comedies Dramas International movies_users", type: "INTEGER", nullable: false),
                    ComediesInternationalMovies = table.Column<int>(name: "Comedies International movies_users", type: "INTEGER", nullable: false),
                    ComediesRomanticMovies = table.Column<int>(name: "Comedies Romantic movies_users", type: "INTEGER", nullable: false),
                    ...
                    DocumentariesInternationalMovies = table.Column<int>(name: "Documentaries International movies_users", type: "INTEGER", nullable: false),
                    Docuseries = table.Column<int>(type: "INTEGER", nullable: false),
                    Dramas = table.Column<int>(type: "INTEGER", nullable: false),
                    DramasInternationalMovies = table.Column<int>(name: "Dramas International movies_users", type: "INTEGER", nullable: false),
                    DramasRomanticMovies = table.Column<int>(name: "Dramas Romantic movies_users", type: "INTEGER", nullable: false),
                    FamilyMovies = table.Column<int>(name: "Family movies_users", type: "INTEGER", nullable: false),
                    Fantasy = table.Column<int>(type: "INTEGER", nullable: false),
                    HorrorMovies = table.Column<int>(name: "Horror movies_users", type: "INTEGER", nullable: false),
                    InternationalMoviesThrillers = table.Column<int>(name: "International movies_users Thrillers", type: "INTEGER", nullable: false),
